...
$pageset_class=$_M['form']['pageset']?' pageset':'';
$pageset_url=$_M['form']['pageset']?"{$_M[url][adminurl]}n=ui_set&c=index&a=dochange_skin":"{$_M[url][own_form]}a=doeditor";
echo <<<EOT
-->
...
<!--
EOT;
$mb_list_w=$_M['form']['pageset']?'col-xs-12 col-sm-6 col-md-4 col-lg-3':'col-xs-12';
...
if(!file_exists(PATH_WEB.$val['mb_view'])) $val['mb_view']='public/images/metinfo.gif';
echo <<<EOT
-->
