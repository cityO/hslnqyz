...
<link rel="stylesheet" type="text/css" href="{$c.met_weburl}templates/{$c.met_skin_user}/cache/{$met_page}.css?{$page_css_time}"/>
<?php }?>
<style>
...
<script src="{$c.met_weburl}templates/{$c.met_skin_user}/cache/{$met_page}.js?{$page_js_time}"></script>
<?php }?>
