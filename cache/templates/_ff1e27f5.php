...
<link rel='stylesheet' type='text/css' href='http://hansong.loc/public/ui/v2/static/css/basic.css'>
...
<?php } ?>
<?php if($met_page){ if($met_page == 404){$met_page = "show";}  $page_css_time = filemtime(PATH_TEM."cache/".$met_page.".css");?>
<link rel="stylesheet" type="text/css" href="<?php echo $c['met_weburl'];?>templates/<?php echo $c['met_skin_user'];?>/cache/<?php echo $met_page;?>.css?<?php echo $page_css_time;?>"/>
<?php }?>
<style>
...
<?php } ?>
<?php if($met_page){ $page_js_time = filemtime(PATH_TEM."cache/".$met_page.".js");?>
<script src="<?php echo $c['met_weburl'];?>templates/<?php echo $c['met_skin_user'];?>/cache/<?php echo $met_page;?>.js?<?php echo $page_js_time;?>"></script>
<?php }?>
